...
const MiniNavigationMarketplaceItems = () => {
	...
	return (
		<>
			...
			<Tooltip placement="right" color="#fd6728" title="Member Classifieds">
				<li className={`menu-item ${location.pathname.includes("/memberclassifieds") ? "active" : ""}`}>
					<Link className="menu-item-link" to="/memberclassifieds">
						<svg
			...
			<Tooltip placement="right" color="#fd6728" title="Real Estates">
				<li className={`menu-item ${location.pathname.includes("/realestates") ? "active" : ""}`}>
					<Link className="menu-item-link text-tooltip-tfr" to="/realestates">
						<svg
							className="menu-item-link-icon icon-events menu-item-link-icon market-place-icon icon-forums"
							xmlns="http://www.w3.org/2000/svg"
							width="1em"
							height="1em"
							viewBox="0 0 24 24"
			...
			<Tooltip placement="right" color="#fd6728" title="Automotives">
				<li className={`menu-item ${location.pathname.includes("/automotives") ? "active" : ""}`}>
					<Link className="menu-item-link text-tooltip-tfr" to="/automotives">
						<svg
