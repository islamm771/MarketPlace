...
const MiniNavigationCareerItems = () => {
	return (
		<>
			<li className="menu-item active">
				<Link className="menu-item-link market-icon-header-link" to="/careers">
					<svg
						className="menu-item-link-icon icon-events menu-item-link-icon icon-forums market-place-icon market-icon-header"
			...
			<li className="menu-item">
				<Link className="menu-item-link" to="/careers">
					<svg
			...
			<li class="menu-item">
				<Link className="menu-item-link text-tooltip-tfr" to="/careers">
					<svg
...
export default MiniNavigationCareerItems;
