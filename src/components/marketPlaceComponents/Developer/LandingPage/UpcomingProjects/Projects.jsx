...
const UpcomingProjects = () => {
  return (
    <div className="upcomimg-projects-section bg-white py-[4rem] lg:py-[6rem] mb-[25px]">
      <div className="marketplace-container">
        <div className="grid lg:!grid-cols-12">
          <div className="lg:col-span-4">
            <div className="upcomingProjects-heading special-landing-heading">
              <span>Properties</span>
              <h1 className="">Upcoming Projects</h1>
              <p className="my-[30px]">
