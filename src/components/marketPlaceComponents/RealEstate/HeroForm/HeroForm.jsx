...
import RealLandingForm from '../Form/RealLandingForm'
import DeveloperLandingForm from '../../Developer/Form/DeveloperLandingForm'
...
const [activeForm , setActiveFrom] = useState("real")
  ...
  return (
    ...
    {activeForm == "developer" && <DeveloperLandingForm />}
    {activeForm == "agency" && <AgencyLandingForm />}
    {activeForm == "owner" && <OwnerLandingForm />}
    </div>
    </>
  )
}
