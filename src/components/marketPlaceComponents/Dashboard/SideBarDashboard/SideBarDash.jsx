...
const sidebarItems = [
    ...
    >
      ...
      buttons: ["Dashboard" , "My Listings" , "Add Listing" , "Classifieds Chat" , "Fav List" , "Purchased"]
    },
    {
      id: 2,
      title: "Real Estate",
    ...
    >
      ...
      buttons: ["Dashboard" , "My Properties" , "Add Property" , "Property Chat" , "Fav List" , "Purchased"]
    ...
    },
    {
      ...
      buttons: ["Dashboard" , "My Automotives" , "Add Automotives" , "Automotives Chat" , "Fav List" , "Purchased"]
    ...
    const handleMainButton = (button) =>{
      ...
      const renderItems = sidebarItems.map((item) => (
        <div class="sidebar-menu-item" key={item.id}>
          <div
            className={`${buttonStates[item.function] && "active"} sidebar-menu-header accordion-trigger-linked`}
