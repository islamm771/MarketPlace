...
const AddProduct = () => {
  ...
  return (
    <div className="relative">
      ...
      >
        <a className="dropdown-navigation-link" href="/marketplace/dashboard/addlisting">
          <svg
        ...
        <a className="dropdown-navigation-link" href="/marketplace/dashboard/addproperty">
          <svg
            className="me-[5px] inline"
            xmlns="http://www.w3.org/2000/svg"
            width="1em"
        ...
        <a className="dropdown-navigation-link" href="/marketplace/dashboard/addautomotive">
          <svg
            className="me-[5px] inline"
            xmlns="http://www.w3.org/2000/svg"
            width="1em"
