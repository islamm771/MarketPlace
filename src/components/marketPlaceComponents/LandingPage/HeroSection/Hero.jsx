...
import "./Hero.css"
import RealLandingForm from '../../RealEstate/Form/RealLandingForm'
import MemberLandingForm from '../../MemberClassifieds/Form/MemberLandingForm'
import AutoLandingForm from '../../Automotives/Form/AutoLandingForm'
          ...
          {children ? (
            ...
            <>
              ...
              <div className="all-hero-forms">
                ...
                {activeForm == "member" && <MemberLandingForm />}
                {activeForm == "auto" && <AutoLandingForm />}
              </div>
            </>
          )}
        </div>
