          ...
          <div className="widget ltn__menu-widget">
            ...
            <ul>
              <li ref={dropProviderRef}>
                <Dropdown
                  optionsArray={Providers}
                  defaultValue={"Providers"}
                  selectedValue={provider}
                  setValue={setProvider}
                  dropRef={dropProviderRef}
                />
              </li>
            </ul>
            {provider?.toLowerCase() == "developer" && (
              <>
                ...
                <div ref={dropDeveloperRef}>
                  <Dropdown
                    optionsArray={Developers}
                    defaultValue={"Developers"}
                    selectedValue={developer}
                    setValue={setDeveloper}
                    dropRef={dropDeveloperRef}
                  />
                </div>
                <h4 className="ltn__widget-title my-[15px]">Communities</h4>
                <div ref={dropCommunityRef}>
                  <Dropdown
                    optionsArray={Communities}
                    defaultValue={"Communities"}
                    selectedValue={community}
                    setValue={setCommunity}
                    dropRef={dropCommunityRef}
                  />
                </div>
                {community && <>
                  <h4 className="ltn__widget-title my-[15px]">Compounds</h4>
                  <div ref={dropCompoundRef}>
                    <Dropdown
                      optionsArray={(Communities.filter( com => com.value == community))[0].compounds}
                      defaultValue={"Compounds"}
                      selectedValue={compound}
                      setValue={setCompound}
                      dropRef={dropCompoundRef}
                    />
                  </div>
                </>}
              </>
            ...
            <h4 className="ltn__widget-title mb-[15px]">
              Area (m<sup>2</sup>)
            </h4>
